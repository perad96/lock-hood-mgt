...
class TaskController extends Controller
{
    ...
    public function allView(Request $request)
    {
        try{
            ...
            return view('supervisor.task_list')->with($this->resources);
        }catch (\Exception $e){
    ...
    public function addView(Request $request)
    {
        try{
            ...
            return view('supervisor.task_add')->with($this->resources);
        }catch (\Exception $e){
            $this->resources['common_msg'] = $this->dangerWithMessage($e->getMessage());
            return redirect()->back()->with($this->resources);
        }
    ...
    public function infoView(Request $request)
    {
        try{
            ...
            if ($obj != null){
                ...
                return view('supervisor.task_update')->with($this->resources);
            }else{
