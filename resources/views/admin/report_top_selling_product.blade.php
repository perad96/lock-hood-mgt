        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="get" action="{{url('admin/reports/view-top-selling-product')}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                @if(count($allArr) > 0)
                                    <div class="col-md-7 text-right">
                                        <div class="form-group mt-3">
                                            <label>&nbsp;</label>
                                            <a href="{{url('admin/reports/export-top-selling-product?month=').request()->get('month')}}" class="btn btn-warning"><i class="fa fa-file-excel-o mr-2"></i>Export</a>
                                        </div>
                                    </div>
                                @endif
                            </div>
