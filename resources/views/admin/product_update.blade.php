                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="name" value="{{(old('name') !== null) ? old('name') : $obj['name'] }}" type="text" class="form-control @error('name')is-invalid @enderror">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="unit_price" value="{{(old('unit_price') !== null) ? old('unit_price') : $obj['unit_price'] }}" type="number" class="form-control @error('unit_price')is-invalid @enderror">
