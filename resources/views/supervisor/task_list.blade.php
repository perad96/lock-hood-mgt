...
@section('content')
    <div class="content">
        ...
        <a href="{{url('supervisor/tasks/add')}}" class="btn btn-primary">+ New Task</a>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title d-flex align-items-center mt-0">
                            ...
                            {{--                            <a href="{{url('supervisor/tasks/export')}}" class="btn btn-warning ml-auto m-0"><i class="fa fa-file-excel-o mr-2"></i>Export</a>--}}
                        </h5>
                    </div>
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            @foreach($allArr as $obj)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{url('supervisor/tasks/info/'.$obj['id'])}}" class="btn btn-sm btn-info mr-1"><i class="fa fa-eye"></i></a>
                                        @if($obj['status'] != 'COMPLETED')
                                            <a href="{{url('supervisor/tasks/delete/'.$obj['id'])}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
